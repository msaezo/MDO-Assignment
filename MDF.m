...
lb = [20,24.08,0.2,0.2,4.4,-4,-4,CST(1)*0.5,CST(2)*0.5,CST(3)*0.5,CST(4)*0.5,...
    CST(5)*0.99,CST(6)*0.99,CST(7)*0.5,CST(8)*0.5,CST(9)*0.5,CST(10)*0.5,CST(11)*...
    (-1.5),CST(12)*(-1.5),CST(13)*0.5,CST(14)*0.5,CST(15)*0.5,CST(16)*0.5,...
    CST(17)*0.99,CST(18)*0.99,CST(19)*0.5,CST(20)*0.5,CST(21)*0.5,CST(22)*0.5,CST(23)*...
    (-1.5),CST(24)*(-1.5)]./X0;
ub = [30,35.08,0.8,0.8,6.4,4,4,CST(1)*1.5,CST(2)*1.5,CST(3)*1.5,CST(4)*1.5,...
    CST(5)*1.5,CST(6)*1.5,CST(7)*1.5,CST(8)*1.5,CST(9)*1.5,CST(10)*1.5,CST(11)...
    ,CST(12),CST(13)*1.5,CST(14)*1.5,CST(15)*1.5,CST(16)*1.5,...
    CST(17)*1.5,CST(18)*1.5,CST(19)*1.5,CST(20)*1.5,CST(21)*1.5,CST(22)*1.5,1.1*CST(23)...
    ,1.1*CST(24)]./X0;
