...
AC.Aero.alt   = 7924.8;                           % flight altitude (m)
AC.Aero.M     = 0.76;                             % flight Mach number 
speed_of_sound  = 308.381;                        % at 7924.8m
AC.Aero.V     = AC.Aero.M*speed_of_sound;         % flight speed (m/s)
d_visc = 0.0000154335;                 %at 7924.8m
...
AC.Aero.CL    = MTOW*n/(q*S);          % lift coefficient - comment this line to run the code for given alpha%
